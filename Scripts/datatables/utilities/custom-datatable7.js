...
$(document).ready(function () {
    ...
    var table = $('#TableId').DataTable(
    {
        ...
        "columnDefs": [
            { "className": "text-center custom-middle-align", "targets": [1, 2, 3, 4, 5, 6, 7] },
        ],
        "language":
            {
        ...
        "ajax":
            {
                "url": "/Utilities/GetuExternalTicketData?id=Unanswered",
                "type": "POST",
                "dataType": "JSON"
            },
        "columns": [
                    ...
                    { "data": "Priority" },
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            //if (type === 'display') {
                            data = '<a class="btn btn-default btn-sm" id="uApprove" title="' + row.ticketRef + '"><i class="fa fa-thumbs-o-up"></i></a>';
                            //}
    ...
    $('#TableId tbody').on('click', '#uApprove', function (e) {
        e.preventDefault();
