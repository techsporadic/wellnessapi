...
$(document).ready(function () {
    ...
    var table = $('#TableId').DataTable(
    {
        ...
        "columnDefs": [
            { "className": "text-center custom-middle-align", "targets": [1, 2, 3, 4, 5, 6, 7, 8] },
        ],
        "language":
            {
        ...
        "ajax":
            {
                "url": "/Utilities/GetuExternalTicketData?id=Closed",
                "type": "POST",
                "dataType": "JSON"
            },
        "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            //if (type === 'display') {
                            data = '<a class="btn btn-default btn-sm" id="getViewWord" title="' + row.CaseRef + '"><i class="fa fa-file-word-o"></i></a>';
                            //}
